...
* **admin:** OpenAPI 스펙에서 API 타입 생성 파이프라인 도입 ([#118](https://github.com/chahyunwoo/hyunwoo-dev/issues/118)) ([2ed9e3e](https://github.com/chahyunwoo/hyunwoo-dev/commit/2ed9e3eb9b326bf95d410c6b96243aa07da94f68))
...
* **blog:** SEO 최적화 - sitemap 확장, canonical/hreflang 보강 ([860f005](https://github.com/chahyunwoo/hyunwoo-dev/commit/860f005f9cb035d6c101bb43e953e736edc4c54c))
...
* OpenAPI 스펙에서 API 타입 생성 파이프라인 도입 ([#118](https://github.com/chahyunwoo/hyunwoo-dev/issues/118)) ([1d4d822](https://github.com/chahyunwoo/hyunwoo-dev/commit/1d4d82272be34b3d2c929c74e82f090daf67b55c))
...
* **portfolio:** 방문 통계 추적 추가, trackPageview를 shared로 공용화 ([e4518b6](https://github.com/chahyunwoo/hyunwoo-dev/commit/e4518b6e4b9fd5bc171f2198fe2138bb72d616b7))
...
* **admin:** getIcon이 아이콘 아닌 lucide export를 반환하던 문제 ([#124](https://github.com/chahyunwoo/hyunwoo-dev/issues/124)) ([986deef](https://github.com/chahyunwoo/hyunwoo-dev/commit/986deef8a44564e810eac817911c0b33a532e100))
...
* **admin:** 토큰 동시 갱신 시 일부 요청만 "Session expired"로 죽던 문제 ([7eb8368](https://github.com/chahyunwoo/hyunwoo-dev/commit/7eb83687e379d2f237cc942e58909d55e7413c4b))
* **admin:** 프리뷰 토큰을 글 slug 에 묶어 발급받는다 ([#125](https://github.com/chahyunwoo/hyunwoo-dev/issues/125)) ([a1c63d0](https://github.com/chahyunwoo/hyunwoo-dev/commit/a1c63d086aaac79a55dbc13b08e4631bbeca0ab8))
...
* **blog:** sitemap 빈 배포 가드를 Vercel 빌드에서만 작동하도록 한정 ([0a1d60f](https://github.com/chahyunwoo/hyunwoo-dev/commit/0a1d60f52f4942f0661f59b55b941a4d55b12db6))
* **blog:** sitemap 을 동적 라우트로 바꿔 새 글이 즉시 반영되게 한다 ([#143](https://github.com/chahyunwoo/hyunwoo-dev/issues/143)) ([2f62cde](https://github.com/chahyunwoo/hyunwoo-dev/commit/2f62cde3eb00ec2fd5bf547e28d2995f5c918e81))
...
* **blog:** 사이드바 카테고리·태그가 사라진 것을 고친다 ([1549fa2](https://github.com/chahyunwoo/hyunwoo-dev/commit/1549fa21fe7a292e2fbda008806e5a8d0919c347))
* **blog:** 새 글이 sitemap에 반영되지 않던 문제와 크롤 예산 낭비 수정 ([19b83c9](https://github.com/chahyunwoo/hyunwoo-dev/commit/19b83c947133dc472da30172e246121346512e1f))
...
* **ci:** openapi-sync-check 워크플로 YAML이 깨져 로드조차 안 되던 문제 ([#118](https://github.com/chahyunwoo/hyunwoo-dev/issues/118)) ([536a5d8](https://github.com/chahyunwoo/hyunwoo-dev/commit/536a5d8c71ea622901a68e11fbdc6bf18793a6a6))
* **ci:** 스펙 동기화 검사가 병합 즉시 영구 no-op이 되던 문제 ([#118](https://github.com/chahyunwoo/hyunwoo-dev/issues/118)) ([f3e127a](https://github.com/chahyunwoo/hyunwoo-dev/commit/f3e127aa69ada672d009fee6376616860d0fceb9))
...
* **portfolio:** 문의 폼 이름 최소길이를 서버 DTO와 일치시킴 ([f947aef](https://github.com/chahyunwoo/hyunwoo-dev/commit/f947aef9190bbfca5c6d87b01fc31b26ff0cccb5))
...
* **shared:** apiFetch 실패를 로그로 남긴다 ([#139](https://github.com/chahyunwoo/hyunwoo-dev/issues/139)) ([9f048e9](https://github.com/chahyunwoo/hyunwoo-dev/commit/9f048e9a60d12114e10b7391ad40f037c35de7c8))
* **shared:** trackPageview를 lib barrel에서 분리해 CI typecheck 실패 해결 ([2a9c50a](https://github.com/chahyunwoo/hyunwoo-dev/commit/2a9c50af2f771b33303c3d94834a6ae584566178))
* **shared:** 응답 스키마 없는 라우트가 조용히 통과하던 문제 수정 ([#118](https://github.com/chahyunwoo/hyunwoo-dev/issues/118)) ([c64faa4](https://github.com/chahyunwoo/hyunwoo-dev/commit/c64faa46ddb40e5ff32c369a2b56d0540da693a3))
* **shared:** 환경변수 값을 trim해 개행 때문에 API가 전부 401나던 문제 ([180739f](https://github.com/chahyunwoo/hyunwoo-dev/commit/180739f555bb0136a708d0d48008a728196b1016))
* **ui:** getIcon 을 packages/ui 로 합치고 blog 의 검증 없는 구현을 없앤다 ([#138](https://github.com/chahyunwoo/hyunwoo-dev/issues/138), [#124](https://github.com/chahyunwoo/hyunwoo-dev/issues/124)) ([eb1890b](https://github.com/chahyunwoo/hyunwoo-dev/commit/eb1890b912030087cbb381d3cbe74a2cd94da772))
...
* 환경변수 개행으로 API가 전부 401나던 문제 + 토큰 갱신 경합 ([50626df](https://github.com/chahyunwoo/hyunwoo-dev/commit/50626df59b8edbf78f010a559894fbe35f17f585))
